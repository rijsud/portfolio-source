  ...
  return (
    <ul className="ml-1 mt-8 flex items-center" aria-label="Social media">
      ...
      <li className="mr-5 shrink-0 text-xs">
        <a
          className="block origin-center text-text-secondary transition duration-200 hover:scale-110 hover:text-accent"
      ...
      <li className="shrink-0 text-xs">
        <a
          className="group block origin-center text-text-secondary transition duration-200 hover:scale-110 hover:text-accent"
          href="mailto:rijul.s@outlook.com"
          target="_blank"
          rel="noreferrer noopener"
